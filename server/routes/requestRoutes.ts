...
requestRouter.patch("/friend_requests/accept/:requestId", isAuthenticated, acceptFriendRequest);
requestRouter.patch("/friend_requests/reject/:requestId", isAuthenticated, rejectFriendRequest);

// Group requests
requestRouter.get("/group_requests/:groupId", getGroupRequests);
requestRouter.post("/group_requests", createGroupRequest);
requestRouter.patch("/group_requests/accept/:requestId", acceptGroupRequest);
requestRouter.patch("/group_requests/reject/:requestId", rejectGroupRequest);
...
requestRouter.patch("/group_creation_requests/accept/:requestId", isAuthenticated, isAdmin, acceptGroupCreationRequest);
requestRouter.patch("/group_creation_requests/reject/:requestId", isAuthenticated, isAdmin, rejectGroupCreationRequest);
