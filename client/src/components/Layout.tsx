  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 h-screen overflow-hidden scrollbar-hide p-10">
        <div className="flex gap-10 mx-auto w-screen max-w-[1000px] h-screen overflow-hidden pb-20">
          <main className="flex-[2_1_auto] overflow-y-auto pr-4">
            {children}
          </main>
          <aside className="flex-auto h-screen">
