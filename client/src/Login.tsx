const Login = () => {
  return (
    <section className='flex w-svw h-svh items-center justify-center bg-primary-900'>
      <form>
        <div className='p-12 border-solid rounded-lg shadow-lg flex flex-col gap-16 bg-primary-800'>
          <div className="flex flex-col gap-2">
            <img className="size-12 object-cover mx-auto" src="/logo56x56.png" alt="Logo here" />
          ...
          <p className="py-4"> Don't have an account? <a className="font-bold">Register</a> </p>
